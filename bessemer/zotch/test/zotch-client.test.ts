...
test('ZotchClient.fetchRequestById - success', async () => {
...
test('ZotchClient.fetchRequestById - not found error', async () => {
  const requestId = Uuid4.generate()
  const apiKey = Uuid4.generate()
...
test('ZotchClient.fetchRequestById - fetch failure', async () => {
  const requestId = Uuid4.generate()
  const apiKey = Uuid4.generate()
...
test('ZotchClient.fetchRequestById - invalid request', async () => {
  const apiKey = Uuid4.generate()
...
test('ZotchClient.fetchRequestById - invalid response', async () => {
  const requestId = Uuid4.generate()
  const apiKey = Uuid4.generate()
...
test('ZotchClient.fetchRequestById - invalid error', async () => {
  const requestId = Uuid4.generate()
  const apiKey = Uuid4.generate()

  {
    const zotch = Zotch.client(RequestApi, {
      fetch: async () => {
        return new Response('50', { status: 401 })
      },
    })
...
test('ZotchClient.createQuote - success', async () => {
  const apiKey = Uuid4.generate()
