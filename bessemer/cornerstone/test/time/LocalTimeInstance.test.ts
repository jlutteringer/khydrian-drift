...
describe('LocalTimeInstance.now', () => {
  test('should return current local time in UTC', () => {
    ...
    const result = LocalTimeInstance.now(clock)
  ...
  test('should use default system clock when no clock provided', () => {
    const result = LocalTimeInstance.now()
  ...
  test('should handle DST transition correctly - spring forward', () => {
    ...
    const resultBefore = LocalTimeInstance.now(clockBefore)
    const resultAfter = LocalTimeInstance.now(clockAfter)
...
describe('LocalTimeInstance.fromDuration', () => {
  test('should create LocalTimeInstance from zero duration', () => {
    const result = LocalTimeInstance.fromDuration(Durations.Zero)
  ...
  test('should create LocalTimeInstance from hour-only durations', () => {
    const result1 = LocalTimeInstance.fromDuration(Durations.fromHours(1))
    expect(result1.hour).toBe(1)
    expect(result1.minute).toBe(0)
    expect(result1.second).toBe(0)
    expect(result1.millisecond).toBe(0)

    const result5 = LocalTimeInstance.fromDuration(Durations.fromHours(5))
    expect(result5.hour).toBe(5)
    expect(result5.minute).toBe(0)
    expect(result5.second).toBe(0)
    expect(result5.millisecond).toBe(0)

    const result23 = LocalTimeInstance.fromDuration(Durations.fromHours(23))
  ...
  test('should create LocalTimeInstance from minute-only durations', () => {
    const result15 = LocalTimeInstance.fromDuration(Durations.fromMinutes(15))
    expect(result15.hour).toBe(0)
    expect(result15.minute).toBe(15)
    expect(result15.second).toBe(0)
    expect(result15.millisecond).toBe(0)

    const result45 = LocalTimeInstance.fromDuration(Durations.fromMinutes(45))
  ...
  test('should create LocalTimeInstance from second-only durations', () => {
    const result30 = LocalTimeInstance.fromDuration(Durations.fromSeconds(30))
    expect(result30.hour).toBe(0)
    expect(result30.minute).toBe(0)
    expect(result30.second).toBe(30)
    expect(result30.millisecond).toBe(0)

    const result59 = LocalTimeInstance.fromDuration(Durations.fromSeconds(59))
  ...
  test('should create LocalTimeInstance from millisecond-only durations', () => {
    const result500 = LocalTimeInstance.fromDuration(Durations.fromMilliseconds(500))
    ...
    const result999 = LocalTimeInstance.fromDuration(Durations.fromMilliseconds(999))
  ...
  test('should create LocalTimeInstance from combined durations', () => {
    ...
    const result = LocalTimeInstance.fromDuration(duration)
  ...
  test('should handle wrapping around 24-hour boundary with positive overflow', () => {
    ...
    const result25h = LocalTimeInstance.fromDuration(Durations.fromHours(25))
    ...
    const result48h = LocalTimeInstance.fromDuration(Durations.fromHours(48))
    ...
    const result26h30m = LocalTimeInstance.fromDuration(Durations.fromHours(26.5))
  ...
  test('should handle wrapping around 24-hour boundary with negative durations', () => {
    ...
    const resultNeg1h = LocalTimeInstance.fromDuration(Durations.fromHours(-1))
    ...
    const resultNeg1h30m = LocalTimeInstance.fromDuration(Durations.fromHours(-1.5))
    ...
    const resultNeg25h = LocalTimeInstance.fromDuration(Durations.fromHours(-25))
  ...
  test('should handle complex negative durations with mixed components', () => {
    ...
    const result = LocalTimeInstance.fromDuration(negativeDuration)
  ...
  test('should handle exactly one day duration', () => {
    const result = LocalTimeInstance.fromDuration(Durations.OneDay)
  ...
  test('should handle edge case near midnight', () => {
    ...
    const result = LocalTimeInstance.fromDuration(almostMidnight)
  ...
  test('should handle very large positive durations', () => {
    ...
    const result = LocalTimeInstance.fromDuration(largeDuration)
  ...
  test('should handle fractional milliseconds by truncating', () => {
    ...
    const result = LocalTimeInstance.fromDuration(fractionalDuration)
  ...
  test('should maintain precision with small durations', () => {
    ...
    const result = LocalTimeInstance.fromDuration(smallDuration)
  ...
  test('should consistently handle the same duration multiple times', () => {
    ...
    const result1 = LocalTimeInstance.fromDuration(duration)
    const result2 = LocalTimeInstance.fromDuration(duration)
...
describe('LocalTimeInstance.fromString', () => {
  test('should create LocalTimeInstance from valid time strings with hours and minutes', () => {
    const result = LocalTimeInstance.fromString('14:30')
  ...
  test('should create LocalTimeInstance from valid time strings with hours, minutes, and seconds', () => {
    const result = LocalTimeInstance.fromString('09:15:45')
  ...
  test('should create LocalTimeInstance from valid time strings with milliseconds', () => {
    const result = LocalTimeInstance.fromString('23:59:59.999')
  ...
  test('should handle single-digit hours', () => {
    const result = LocalTimeInstance.fromString('5:30')
  ...
  test('should handle midnight', () => {
    const result = LocalTimeInstance.fromString('0:00')
  ...
  test('should handle milliseconds with 1 digit by padding', () => {
    const result = LocalTimeInstance.fromString('12:30:45.5')
  ...
  test('should handle milliseconds with 2 digits by padding', () => {
    const result = LocalTimeInstance.fromString('12:30:45.75')
  ...
  test('should handle zero seconds and milliseconds', () => {
    const result = LocalTimeInstance.fromString('10:20:00.000')
  ...
  test('should handle edge case with minimum valid values', () => {
    const result = LocalTimeInstance.fromString('0:00:00.000')
  ...
  test('should handle noon correctly', () => {
    const result = LocalTimeInstance.fromString('12:00')
  ...
  test('should handle various valid time combinations', () => {
    ...
    testCases.forEach(({ input, expected }) => {
      const result = LocalTimeInstance.fromString(input)
  ...
  test('should throw error for invalid time formats', () => {
    expect(() => LocalTimeInstance.fromString('12:30:45.12345')).toThrow()
    expect(() => LocalTimeInstance.fromString('14')).toThrow()
    expect(() => LocalTimeInstance.fromString('14:3a')).toThrow()
    expect(() => LocalTimeInstance.fromString('14-30')).toThrow()
    expect(() => LocalTimeInstance.fromString('24:00')).toThrow()
    expect(() => LocalTimeInstance.fromString('-1:00')).toThrow()
    expect(() => LocalTimeInstance.fromString('12:60')).toThrow()
    expect(() => LocalTimeInstance.fromString('12:-5')).toThrow()
    expect(() => LocalTimeInstance.fromString('12:30:60')).toThrow()
    expect(() => LocalTimeInstance.fromString('12:30:-1')).toThrow()
    expect(() => LocalTimeInstance.fromString('')).toThrow()
    expect(() => LocalTimeInstance.fromString('12:30:45.')).toThrow()
    expect(() => LocalTimeInstance.fromString('12:5')).toThrow()
    expect(() => LocalTimeInstance.fromString('12:30:5')).toThrow()
    expect(() => LocalTimeInstance.fromString('   ')).toThrow()
    expect(() => LocalTimeInstance.fromString('12:30:45abc')).toThrow()
    expect(() => LocalTimeInstance.fromString(' 12:30:45 ')).toThrow()
    expect(() => LocalTimeInstance.fromString('12::30')).toThrow()
