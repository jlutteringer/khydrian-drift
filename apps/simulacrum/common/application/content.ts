...
export const ApplicationContent: Array<StaticContentData> = [
  ...
  Content.staticData('test-content-client', TextContentType, 'Hello, from the Client!'),
  Content.staticData('test-content-server', TextContentType, 'Hello, from the Server!'),
