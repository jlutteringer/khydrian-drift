...
export namespace PlayerCharacteristics {
  export const Brawn: Characteristic<number> = Characteristics.defineCharacteristic({
    template: Characteristics.defineTemplate('efa1484a-1fd5-4224-ac42-7cbad79af90a', 'Strength', ObjectPaths.from('strength')),
    initialValue: true,
  })

  export const Agility: Characteristic<number> = Characteristics.defineCharacteristic({
    template: Characteristics.defineTemplate('1959d7a0-c49e-4323-be59-538578c83f8e', 'Agility', ObjectPaths.from('agility')),
    initialValue: true,
  })

  export const Willpower: Characteristic<number> = Characteristics.defineCharacteristic({
    template: Characteristics.defineTemplate('85a528bb-c1e9-45ea-9ab0-ecf7420d87b8', 'Wisdom', ObjectPaths.from('wisdom')),
    initialValue: true,
  })

  export const Intelligence: Characteristic<number> = Characteristics.defineCharacteristic({
    template: Characteristics.defineTemplate('23e5a5de-b7fb-43e7-9363-27504a6b9fc0', 'Intelligence', ObjectPaths.from('intelligence')),
    initialValue: true,
  })

  export const Presence: Characteristic<number> = Characteristics.defineCharacteristic({
    template: Characteristics.defineTemplate('f213fad6-8c4f-4e01-891c-e9d4da079e72', 'Charisma', ObjectPaths.from('charisma')),
    initialValue: true,
  })
