...
export namespace PlayerCharacteristics {
  export const Strength: Characteristic<number> = Characteristics.defineCharacteristic({
    template: Characteristics.defineTemplate('d5918660-631d-4235-9255-c5e3ffe12533', 'Strength', ObjectPaths.from('strength')),
    initialValue: true,
  })

  export const Dexterity: Characteristic<number> = Characteristics.defineCharacteristic({
    template: Characteristics.defineTemplate('f99bd4b3-758e-4268-93be-79e4eb705996', 'Dexterity', ObjectPaths.from('dexterity')),
    initialValue: true,
  })

  export const Constitution: Characteristic<number> = Characteristics.defineCharacteristic({
    template: Characteristics.defineTemplate('e6a76947-c31e-4d41-8598-baefc3b1e788', 'Constitution', ObjectPaths.from('constitution')),
    initialValue: true,
  })

  export const Wisdom: Characteristic<number> = Characteristics.defineCharacteristic({
    template: Characteristics.defineTemplate('72e3dd16-6fb9-4498-8c29-60f489309819', 'Wisdom', ObjectPaths.from('wisdom')),
    initialValue: true,
  })

  export const Intelligence: Characteristic<number> = Characteristics.defineCharacteristic({
    template: Characteristics.defineTemplate('e96116ef-9615-4edc-8c83-f0bcb38f5319', 'Intelligence', ObjectPaths.from('intelligence')),
    initialValue: true,
  })

  export const Charisma: Characteristic<number> = Characteristics.defineCharacteristic({
    template: Characteristics.defineTemplate('799e5562-277d-4af6-9e61-add32c761ac6', 'Charisma', ObjectPaths.from('charisma')),
    initialValue: true,
  })

  export const StrengthModifier: Characteristic<number> = Characteristics.defineCharacteristic({
    template: Characteristics.defineTemplate('ab339ba9-3ff2-4cc4-8bac-454078938c27', 'Strength Modifier', ObjectPaths.from('strengthModifier')),
  ...
  export const DexterityModifier: Characteristic<number> = Characteristics.defineCharacteristic({
    template: Characteristics.defineTemplate('ce1eaad3-8c00-4313-8e50-b7168246b223', 'Dexterity Modifier', ObjectPaths.from('dexterityModifier')),
  ...
  export const WisdomModifier: Characteristic<number> = Characteristics.defineCharacteristic({
    template: Characteristics.defineTemplate('3b60723b-f7f7-48f6-a747-0e72f14a59fa', 'Wisdom Modifier', ObjectPaths.from('wisdomModifier')),
  ...
  export const CharismaModifier: Characteristic<number> = Characteristics.defineCharacteristic({
    template: Characteristics.defineTemplate('60f4ffa4-9486-4c23-8876-86b6a2ea5f30', 'Charisma Modifier', ObjectPaths.from('charismaModifier')),
